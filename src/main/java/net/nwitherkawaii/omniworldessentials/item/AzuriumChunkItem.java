...
public class AzuriumChunkItem extends OmniworldessentialsModElements.ModElement {
	@ObjectHolder("omniworldessentials:azurium_chunk")
	public static final Item block = null;
	public AzuriumChunkItem(OmniworldessentialsModElements instance) {
		super(instance, 26);
	}
