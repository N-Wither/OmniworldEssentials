...
public class AzuriumIngotItem extends OmniworldessentialsModElements.ModElement {
	@ObjectHolder("omniworldessentials:azurium_ingot")
	public static final Item block = null;
	public AzuriumIngotItem(OmniworldessentialsModElements instance) {
		super(instance, 11);
	}
