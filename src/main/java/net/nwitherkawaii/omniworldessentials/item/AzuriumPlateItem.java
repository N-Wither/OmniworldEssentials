...
public class AzuriumPlateItem extends OmniworldessentialsModElements.ModElement {
	@ObjectHolder("omniworldessentials:azurium_plate")
	public static final Item block = null;
	public AzuriumPlateItem(OmniworldessentialsModElements instance) {
		super(instance, 16);
	}
