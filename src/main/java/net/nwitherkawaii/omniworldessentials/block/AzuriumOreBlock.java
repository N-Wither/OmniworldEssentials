...
import net.nwitherkawaii.omniworldessentials.item.AzuriumChunkItem;
...
public class AzuriumOreBlock extends OmniworldessentialsModElements.ModElement {
	@ObjectHolder("omniworldessentials:azurium_ore")
	public static final Block block = null;
	public AzuriumOreBlock(OmniworldessentialsModElements instance) {
		super(instance, 21);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AzuriumChunkItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("omniworldessentials:azurium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("azurium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("omniworldessentials:azurium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
